...
import { discoverGoRoots } from '../../src/go/walk.ts';
import { check as gosumCommitted } from '../../src/go/gosum-committed.ts';
import { check as toolchainPinned } from '../../src/go/toolchain-pinned.ts';
import type { RepoContext } from '../../src/types.ts';

const here = dirname(fileURLToPath(import.meta.url));
const fixturesDir = join(here, 'fixtures', 'checks');
